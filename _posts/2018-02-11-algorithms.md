...
2. [Algorithm Complexity, Big O notation](#big-o)
    2.1. [Big-O tips](#big-o-tips)
    2.2. [Big-O Summary](#big-o-summary)
    2.3. [Big-O Cheatsheet](#big-o-cheatsheet)
3. [Searching Algorithms](#sequential-search)
    3.1. [Sequential Search](#sequential-search)
    3.2. [Binary Search](#Binary-search)
